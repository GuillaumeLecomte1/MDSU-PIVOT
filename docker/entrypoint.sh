...
max_attempts=30
counter=0
until php -r "try { new PDO('mysql:host=mysql;dbname=pivot', 'root', '8ocxlumnakezr2wdfcwiijct2rejsgdr'); echo 'Connected to MySQL'; } catch (PDOException \$e) { echo \$e->getMessage(); exit(1); }" 2>/dev/null
do
